...
namespace AuthoDemoMVC.Data.EmployeeService
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public EmployeeService(UserManager<ApplicationUser> userManager, IConfiguration configuration, ApplicationDbContext context)
        {
        ...
        public async Task<UserManagerResponse> RegisterEmployeeAsync(RegisterEmployeeViewModel model)
        {
            if (model == null)
            ...
            var result = await _userManger.CreateAsync(Employee, model.Password);
            ...
            //ADD USER THE ROLE Employee
            var userRole = new IdentityUserRole<string> {RoleId = "2", UserId = Employee.Id};
